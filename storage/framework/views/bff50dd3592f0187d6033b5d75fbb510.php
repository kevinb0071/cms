...
<?php $component->withAttributes([]); ?>
    <div class="note-container single-note">
        ...
        <form action="<?php echo e(route('note.update', $note)); ?>" method="post" class="note">
            ...
            <textarea name="note" id="note" cols="30" rows="10" class="note-body" placeholder="Enter Your note here">
...
<?php endif; ?>
<?php /**PATH /home/kevin/cms/resources/views/note/edit.blade.php ENDPATH**/ ?>